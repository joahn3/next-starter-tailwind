    ...
    <body className="bg-white">
      <div className="flex flex-col items-center justify-center space-y-10">
        ...
        <h2 className="p-3 font-bold bg-yellow-100 md:text-2xl">
          Greetings! I’m Ionuț, welcome to my Developer Portofolio website.
          <br></br>
          <h2 className="p-3 font-bold bg-yellow-200 md:text-xl">
            I spend my days working as a Security professional and my nights
            plus my free time designing and developing websites and web apps.
          </h2>
        </h2>
        <div>
